...
f.history = ("Created from MMIJ-ALLSTA.csv of 2016-12-21 on 2018-02-28 "  # TODO
...
def process_data(pdf, dss, data_out, attributes):
    ...
    scale = quantize(np.fmax(accuracy_abs/50, resolution))
...
def create_signal(group, instrument, name, dimensions, attributes):
    ...
    if 'accuracy_abs' in s.ncattrs():
        s.accuracy_propagated = (
            "['avg'] accuracy/50 (50 = approx. sqrt(2400)" + '\n'
            "['std'] accuracy/50 (50 = approx. sqrt(2400-1))")
...
attributes = {'long_name': "relative humidity",
              ...
              'units': "%", 'coordinates': "level_air height_air",
              'quality': 'Q1',
...
attributes = {'long_name': "air temperature",
              ...
              'coordinates': "level_air height_air boom direction",
              'quality': 'Q1',
...
attributes = {'long_name': "wind speed", 'standard_name': "wind_speed",
              'units': "m/s",
              'coordinates': "level_CA height_CA boom_CA direction_CA",
...
attributes = {'long_name': "tower shadow-corrected wind speed",
              ...
              'coordinates': "level_CA height_CA",
              'quality': 'Q1',
...
attributes = {'long_name': "wind direction",
              ...
              'units': "degree", 'coordinates': "level_WV height_WV boom direction",
              'quality': 'Q1',
...
attributes = {'long_name': "tower shadow-corrected wind direction",
              ...
              'coordinates': "level_WV height_WV", 'quality': 'Q1',
...
attributes = {'long_name': "sonic status",
              'coordinates': "level_USA height_USA boom direction",
...
attributes = {'long_name': "precipitation presence",
              'coordinates': "level_PD height_PD location_PD", 'quality': 'Q1',
...
attributes = {'long_name': "momentaneous measurement quality", 'units': "%",
              'coordinates': "level_PM height_PM location_PM", 'quality': 'Q5'}
...
attributes = {'long_name': "amount of precipitation since the last sensor reset",
              'units': "mm", 'coordinates': "level_PM height_PM location_PM",
...
attributes = {'long_name': "sensor status", 'units': "%",
              'coordinates': "level_PM height_PM location_PM", 'quality': 'Q1',
              'flag_values': np.float32([0., 100.]),
